...
Integrate IAIndex with your wix site for automatic content attribution.
...
Download the plugin from [GitHub](https://github.com/claimtec/iaindex-wix) and follow the installation instructions.
...
View analytics in your wix dashboard:
...
- [Documentation](https://docs.iaindex.com/plugins/wix)
- [GitHub Issues](https://github.com/claimtec/iaindex-wix/issues)
