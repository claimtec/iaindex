...
Integrate IAIndex with your framer site for automatic content attribution.

## Installation

### Via Plugin Marketplace

1. Log into your framer dashboard
...
Download the plugin from [GitHub](https://github.com/claimtec/iaindex-framer) and follow the installation instructions.
...
View analytics in your framer dashboard:
...
- [Documentation](https://docs.iaindex.com/plugins/framer)
- [GitHub Issues](https://github.com/claimtec/iaindex-framer/issues)
