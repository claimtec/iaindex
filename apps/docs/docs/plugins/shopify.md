...
Integrate IAIndex with your shopify site for automatic content attribution.
...
Download the plugin from [GitHub](https://github.com/claimtec/iaindex-shopify) and follow the installation instructions.
...
View analytics in your shopify dashboard:
...
- [Documentation](https://docs.iaindex.com/plugins/shopify)
- [GitHub Issues](https://github.com/claimtec/iaindex-shopify/issues)
