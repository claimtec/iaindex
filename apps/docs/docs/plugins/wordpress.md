...
Download the plugin from [GitHub](https://github.com/claimtec/iaindex-wordpress) and follow the installation instructions.
...
- [Documentation](https://docs.iaindex.com/plugins/wordpress)
- [GitHub Issues](https://github.com/claimtec/iaindex-wordpress/issues)
