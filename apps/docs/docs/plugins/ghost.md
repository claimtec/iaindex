...
Integrate IAIndex with your ghost site for automatic content attribution.
...
Download the plugin from [GitHub](https://github.com/claimtec/iaindex-ghost) and follow the installation instructions.
...
View analytics in your ghost dashboard:
...
- [Documentation](https://docs.iaindex.com/plugins/ghost)
- [GitHub Issues](https://github.com/claimtec/iaindex-ghost/issues)
