...
Integrate IAIndex with your uuuble site for automatic content attribution.

## Installation

### Via Plugin Marketplace

1. Log into your uuuble dashboard
...
Download the plugin from [GitHub](https://github.com/claimtec/iaindex-bubble) and follow the installation instructions.
...
View analytics in your uuuble dashboard:
...
- [Documentation](https://docs.iaindex.com/plugins/bubble)
- [GitHub Issues](https://github.com/claimtec/iaindex-bubble/issues)
